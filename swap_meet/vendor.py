class Vendor:
    ...
    def swap_best_by_category(self, other_vendor, my_priority, their_priority):
        ...
        item_i_have_they_want = self.get_best_by_category(their_priority)
        item_they_have_i_want = other_vendor.get_best_by_category(my_priority)

        if not item_i_have_they_want or not item_they_have_i_want:
            return False
        
        return self.swap_items(other_vendor, item_i_have_they_want, item_they_have_i_want)